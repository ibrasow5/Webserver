...
public class ServeurWeb {
    ...
    static class ClientHandler implements Runnable {
            ...
            try {
                ...
                if (request != null) {
                    ...
                    if (method.equals("GET")) {
                        if (resource.equals("/") || resource.equals("/Repertoires")) {
                            // Si la ressource demandée est la racine ou le répertoire "Repertoires", envoie le listing des fichiers
                            sendDirectoryListing(out, new File("Repertoires"));
                        } else {
        ...
        private void sendResource(PrintWriter out, String resource) throws IOException {
            ...
            String filePath = "Repertoires" + decodedResource; // Utilisez le chemin décodé
            ...
            if (file.exists()) {
                ...
                // Essayer de rechercher le fichier dans les sous-répertoires de "Repertoires"
                File[] subDirectories = new File("Repertoires").listFiles(File::isDirectory);
                if (subDirectories != null) {
                    for (File subDirectory : subDirectories) {
                        ...
                        if (fileInSubDirectory.exists() && !fileInSubDirectory.isDirectory()) {
                            ...
                            System.out.println("Chemin du fichier : Répertoires/" + subDirectory.getName() + decodedResource); // Affiche le chemin HTTP réel avec le sous-répertoire
